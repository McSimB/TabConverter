...
public class TGFactory {
	...
	public TGMeasure newMeasure(TGMeasureHeader header) {
		return new TGMeasure(this, header) {
	...
	public TGNoteEffect newNoteEffect() {
		return new TGNoteEffect() {
			//TGNoteEffect Implementation
		};
	}

	public TGBeatEffect newBeatEffect() {
		return new TGBeatEffect(this) {
			//TGBeatEffect Implementation
		};
	}
